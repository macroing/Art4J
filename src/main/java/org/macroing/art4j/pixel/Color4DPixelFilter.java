 ...
 * <p>
 * This is a functional interface whose functional method is {@link #isAccepted(Color4D, int, int)}.
 * 
 * @since 1.0.0
 * @author J&#246;rgen Lundgren
 */
@FunctionalInterface
public interface Color4DPixelFilter {
	/**
	 ...
	 */
	boolean isAccepted(final Color4D color, final int x, final int y);
}