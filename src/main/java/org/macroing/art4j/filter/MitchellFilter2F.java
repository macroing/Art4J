...
public final class MitchellFilter2F extends Filter2F {
	...
	public boolean equals(final Object object) {
		if(object == this) {
			...
			return false;
		} else if(!Floats.equals(getResolutionX(), MitchellFilter2F.class.cast(object).getResolutionX())) {
			return false;
		} else if(!Floats.equals(getResolutionY(), MitchellFilter2F.class.cast(object).getResolutionY())) {
			return false;
		} else if(!Floats.equals(this.b, MitchellFilter2F.class.cast(object).b)) {
			return false;
		} else if(!Floats.equals(this.c, MitchellFilter2F.class.cast(object).c)) {
			return false;
		} else {
			return true;
		}
	...
	private static float doMitchell(final float x, final float b, final float c) {
		final float x1 = Floats.abs(2.0F * x);
