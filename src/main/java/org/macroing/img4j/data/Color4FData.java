...
final class Color4FData extends Data {
	...
	public Color4FData(final BufferedImage bufferedImage) {
		this.colors = Arrays.stream(DataBufferInt.class.cast(Utilities.getCompatibleBufferedImage(bufferedImage).getRaster().getDataBuffer()).getData()).mapToObj(colorARGB -> Color4F.fromIntARGB(colorARGB)).toArray(Color4F[]::new);
