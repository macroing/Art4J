...
final class Color4FData extends Data {
	...
	public Color4FData(final int resolutionX, final int resolutionY, final Color4F color) {
		...
		this.colors = new Color4F[ParameterArguments.requireRangeMultiplyExact(resolutionX, resolutionY, 1, Integer.MAX_VALUE, "resolutionX", "resolutionY")];
	...
	public boolean rotate(final double angle, final boolean isAngleInRadians) {
		...
		for(int y = 0; y < newResolutionY; y++) {
			for(int x = 0; x < newResolutionX; x++) {
				...
				newColors[y * newResolutionX + x] = getColor4F(pointRotated.x, pointRotated.y);
			}
		}
	...
	static final class PixelChange implements Change {
		...
		public Color4F getColorRedo() {
			return this.colorRedo;
		}
		
		public Color4F getColorUndo() {
	...
	static final class StateChange implements Change {
		...
		public Color4F[] getColorsRedo() {
			return this.colorsRedo.clone();
		}
		
		public Color4F[] getColorsUndo() {
