...
//	TODO: Add Javadocs!
	...
	public static int redoGammaCorrection(final int colorARGB) {
		final double r = Utilities.redoGammaCorrection(unpackRAsDouble(colorARGB));
		final double g = Utilities.redoGammaCorrection(unpackGAsDouble(colorARGB));
		final double b = Utilities.redoGammaCorrection(unpackBAsDouble(colorARGB));
	...
	public static int undoGammaCorrection(final int colorARGB) {
		final double r = Utilities.undoGammaCorrection(unpackRAsDouble(colorARGB));
		final double g = Utilities.undoGammaCorrection(unpackGAsDouble(colorARGB));
		final double b = Utilities.undoGammaCorrection(unpackBAsDouble(colorARGB));
		final double a =                               unpackAAsDouble(colorARGB);
